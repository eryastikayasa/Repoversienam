...
extern "C" void websocket_gemini_on_disconnected(void) { reset_parser(); s_setup_complete = false; s_greeting_sent = false; s_greeting_finished = false; s_client = nullptr; ESP_LOGW(TAG, "Gemini disconnected"); }
