...
bool audio_engine_set_mic_listener(audio_engine_mic_frame_cb_t cb, void *ctx); bool audio_engine_set_mic_sink(audio_engine_mic_sink_cb_t cb, void *ctx); bool audio_engine_start_capture(void); bool audio_engine_request_capture_stop(void); bool audio_engine_stop_capture_and_wait(void); bool audio_engine_prepare_gemini_input(void); void audio_engine_start_input_session(void); void audio_engine_request_input_session_after_drain(void); void audio_engine_stop_input_session(void); bool audio_engine_input_session_active(void); bool audio_engine_mic_capture_active(void);
